...
import { CreateAccountDto, UpdateAccountDto, AccountQueryDto, InitializeChartOfAccountsDto } from '../dto/account.dto';
...
export class AccountController {
  ...
  @ApiResponse({ status: 201, description: 'Chart of accounts initialized successfully' })
  ...
  async initializeChartOfAccounts(
    ...
    try {
      ...
      const accounts = await this.accountService.initializeChartOfAccounts(data);
  ...
  async createAccount(
    ...
    try {
      const account = await this.accountService.createAccount(user.organizationId, createAccountDto);
  ...
  async getAccounts(
    ...
    try {
      const result = await this.accountService.getAccounts(user.organizationId, query);
  ...
  async getAccountHierarchy(
    ...
    try {
      const hierarchy = await this.accountService.getAccountHierarchy(user.organizationId, accountType);
  ...
  async getAccountSummary(@CurrentUser() user: any) {
    try {
      const summary = await this.accountService.getAccountSummary(user.organizationId);
  ...
  async getAccountsByType(
    ...
    try {
      const accounts = await this.accountService.getAccountsByType(user.organizationId, accountType);
  ...
  async getBankAccounts(@CurrentUser() user: any) {
    try {
      const accounts = await this.accountService.getBankAccounts(user.organizationId);
  ...
  @ApiResponse({ status: 200, description: 'Tax accounts retrieved successfully' })
  async getTaxAccounts(@CurrentUser() user: any) {
    try {
      const accounts = await this.accountService.getTaxAccounts(user.organizationId);
  ...
  async getAccountById(
    ...
    try {
      const account = await this.accountService.getAccountById(user.organizationId, id);
  ...
  async updateAccount(
    ...
    try {
      const account = await this.accountService.updateAccount(user.organizationId, id, updateAccountDto);
  ...
  async deleteAccount(
    ...
    try {
      const account = await this.accountService.deleteAccount(user.organizationId, id);
